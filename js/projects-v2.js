/* =====================================================================
   ...
   ---------------------------------------------------------------------
   Los datos se organizan por CORTES de información (fecha de corte).
   Cada corte tiene su propia lista de láminas (secciones + proyectos).
   window.CORTES  → todos los cortes, en orden cronológico (el último es el más reciente).
   window.PROJECTS → alias al corte más reciente (compatibilidad).
   ===================================================================== */
...
window.CORTES = [
  ...
  /* #################################################################### */
  /* ####################  CORTE: 15 de julio del 2026  ################# */
  /* #################################################################### */
  {
    id: "2026-07-15", fecha: "15/07/2026", label: "15 de julio del 2026",
    projects: [
...

    {
      ...
      fin: {
        costo: "S/ 1,660.4 MM", devengado: "S/ 286.1 MM", avance: "17.2%",
  ...
  /* #################################################################### */
  /* ####################  CORTE: 27 de agosto del 2026  ################ */
  /* #################################################################### */
  {
    id: "2026-08-27", fecha: "27/08/2026", label: "27 de agosto del 2026",
    projects: [
...

    {
      ...
      status: "Por Etapas", statusType: "agua potable y alcantarillado", cui: "2331661",
      fin: {
        costo: "S/ 1,660.4 MM", devengado: "S/ 289.3 MM", avance: "17.4%",
        pim: "S/ 352.9 MM", certificado: "S/ 343.5 MM", devengado26: "S/ 216.3 MM",
        pimEjecutar: "S/ 136.6 MM", ffRO: "S/ 38.1 MM", ffROOC: "S/ 98.6 MM"
      },
      fechaInicio: "25/09/24", fechaFin: "13/02/30", avProg: "7.42%", avEjec: "5.89%",
      notes: [
        "ETAPA 1 → Costo: S/ 5.7 MM. Obra culminada el 31.12.25. Presenta observaciones de la EPS SEDA JULIACA.",
        "ETAPA 2 → Costo: S/ 125.4 MM. Obra en ejecución desde el 31.01.26.",
        "Avance físico → Programado: 7.42% - Ejecutado: 5.89% (Val. N° 05 Junio)",
        "Ago.26: Se programó S/ 1.8 MM, correspondiente al pago de la Val. obra N° 05 (Junio 2026) y supervisión N° 2.",
        "ETAPA 3 → Costo: S/ 513.9 MM. Obra en ejecución desde el 04.05.26. Avance: <1%, se tiene previsto presentación de las valorizaciones en Set.26.",
        "ETAPA 4 → Costo: S/ 799.3 MM. Obra en proceso de LPI (el 23.08.26 el BID remitió las observaciones al Informe de Evaluación de Oferta).",
        "Contratación ingeniero FIDIC 4 (Supervisión): En proceso de contratación (el 14.08.26 el BID remitió las observaciones sobre lista corta).",
        "Contratación de la PMO: Inició actividades el 08/09/25."
      ],
      alert: null,
      hitos: [
        { fecha: "07/09/26", titulo: "Etapa 1 — Aprobación del expediente de intervención correctiva." },
        { fecha: "30/09/26", titulo: "Etapa 2 — Avance de ejecución de obra: 8.6%." },
        { fecha: "30/09/26", titulo: "Etapa 3 — Avance de ejecución de obra: 0.47%." },
        { fecha: "26/08/26", titulo: "Etapa 4 — Remisión al BID del Informe de Evaluación subsanado para la No Objeción. Meta cumplida." },
        { fecha: "27/08/26", titulo: "Ing. FIDIC 4 — Remisión al BID de la lista corta y SDP subsanado para la No Objeción." }
      ],
      riesgo: [
        "ETAPA 1: Retraso en la transferencia a la ESP por la subsanación de defectos e intervención correctiva.",
        "ETAPA 2: Posible conflicto social por superposición de área de intervención entre PIA y ampliación de aeropuerto.",
        "ETAPA 3: Retraso en el desarrollo de actividades y afectación ambiental por inviabilidad del depósito de material excedente Yocará Cambraca.",
        "ETAPA 4: Posible retraso en la adjudicación por falta de presupuesto."
      ],
      deadline: "20.12.29",
      chart: {
        max: 140,
        ejecucion: [0.3, 0.4, 54.4, 133.8, 21.3, 2.8, 2.5, 0.7, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 2.6, 5.7, 15, 102.9, 11.2],
        metaMEF: [null, null, null, null, null, null, null, 2.6, 5.7, 15, 102.9, 11.4]
      }
    },

    {
      ...
      status: "Por Etapas", statusType: "drenaje pluvial", cui: "2459017",
      fin: {
        costo: "S/ 357.8 MM", devengado: "S/ 148.5 MM", avance: "41.5%",
        pim: "S/ 96.9 MM", certificado: "S/ 43.7 MM", devengado26: "S/ 23.5 MM",
        pimEjecutar: "S/ 73.4 MM", ffRO: "S/ 0.6 MM", ffROOC: "S/ 72.8 MM"
      },
      fechaInicio: "30/06/20", fechaFin: "30/06/29", avProg: "78.74%", avEjec: "24.03%",
      notes: [
        "ETAPA 1: TANCARPATA - Obra culminada el 14.04.25",
        "En periodo de responsabilidad por defectos (Corrección de defectos de obra: 13 rejillas corregidas, 7 rejillas en proceso).",
        "ETAPA 2: CACHIMAYO - Obra en ejecución atrasada",
        "Avance físico → Programado: 78.74% - Ejecutado: 24.03% (al 20.07.26)",
        "27.04.26: Se notificó notarialmente el apercibimiento al Contratista.",
        "13.05.26: Se aprobó la medida cautelar por el Poder Judicial (7mo juzgado civil comercial de Lima) que suspende cualquier medida que la entidad pueda tomar asociada a la resolución del contrato.",
        "Ago.26: se devengó S/ 1.9 MM, correspondiente al pago de la Val. N° 16 del contrato (21.05 al 20.06 del 2026).",
        "ETAPA 3: SAPHY - Saldo del Exp. Téc. en procedimiento de selección",
        "19.06.26: El BID otorgó la no objeción al informe de evaluación de ofertas técnicas. En revisión del BID el proyecto de respuesta a un reclamo interpuesto por un oferente."
      ],
      alert: null,
      hitos: [
        { fecha: "Set.26", titulo: "Etapa 3 — Apertura de ofertas económicas." }
      ],
      riesgo: [
        "ETAPA 1: Retrasos en la corrección de defectos de parte del contratista, que podrían generar problemas sociales",
        "ETAPA 2: Retrasos en la ejecución de obra (de responsabilidad del contratista) que podría generar incumplimiento de la ejecución de gastos 2026."
      ...
      chart: {
        max: 10,
        ejecucion: [0, 1.1, 3.6, 1.9, 1.5, 5.3, 4.8, 5.4, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 3.5, 4.7, 6.4, 5.8, 9.1],
        metaMEF: [null, null, null, null, null, null, null, 3.6, 4.6, 6.5, 6.1, 8.4]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable", cui: "2497598",
      fin: {
        costo: "S/ 300.6 MM", devengado: "S/ 157.2 MM", avance: "52.3%",
        pim: "S/ 66.7 MM", certificado: "S/ 66.6 MM", devengado26: "S/ 44.2 MM",
        pimEjecutar: "S/ 22.5 MM", ffRO: "S/ 22.5 MM", ffROOC: "S/ 0.0 MM"
      },
      fechaInicio: "28/06/24", fechaFin: "22/09/26", avProg: "99.5%", avEjec: "55.73%",
      notes: [
        "Avance físico → Programado: 99.5% - Ejecutado: 55.73% (Jun 2026)",
        "Se ejecutan 03 frentes de obra, con 37 frentes concluidos y uno paralizado por hallazgo arqueológico. Se han instalado 33.0 km de tubería de impulsión (90.4% de 36.5 km).",
        "13.02.26: Se firmó la Enmienda N°2, ampliación de plazo al 24.06.26.",
        "25.06.26: Se firmó la Enmienda N°3, ampliación de plazo al 22.09.26",
        "Ago.26: Se programó S/ 5.8 MM correspondientes a la Val. de obra N°24 (Jun 2026) y Val. de supervisión N° 23."
      ],
      alert: { text: "Déficit presupuestal de S/ 11.5 MM para el pago total de valorizaciones, contemplado en el segundo pedido de demanda adicional 2026." },
      hitos: [
        { fecha: "22/09/26", titulo: "Fecha de término contractual. Se prevé una ampliación de plazo." }
      ],
      riesgo: [
        "Dificultades en la gestión de permisos, servidumbres de paso y la presencia de restos arqueológicos, que afectan el ritmo de ejecución y retrasa la culminación de obra."
      ],
      deadline: "22.12.25",
      chart: {
        max: 12,
        ejecucion: [7.6, 7, 5.6, 5.9, 6.3, 6, 5.4, 0.3, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 5.8, 10.8, 6.2, 0, 0],
        metaMEF: [null, null, null, null, null, null, null, 5.8, 10.8, 7, 0, 0]
      }
    },

    {
      ...
      status: "Por Etapas", statusType: "drenaje pluvial", cui: "2519940",
      fin: {
        costo: "S/ 554.9 MM", devengado: "S/ 38.6 MM", avance: "7.0%",
        pim: "S/ 53.9 MM", certificado: "S/ 23.1 MM", devengado26: "S/ 2.5 MM",
        pimEjecutar: "S/ 51.4 MM", ffRO: "S/ 8.7 MM", ffROOC: "S/ 42.7 MM"
      },
      fechaInicio: "04/03/22", fechaFin: "04/03/27", avProg: "—", avEjec: "—",
      notes: [
        "ETAPA 1: Tambopata – 06 Exp. Téc. y 06 Obras – Diseño construcción",
        "06 Expedientes Técnicos en elaboración (avance: 63%), atrasado.",
        "Bloque I: 03 Exp. Téc. y 03 Obras: 10 Entregables → Inició: 07.06.24",
        "1er ET: 7 de 10 entregables aprobados. Entregable N°8 en elaboración.",
        "2do y 3er ET: 6 de 10 entregables aprobados. Entregable N°7 en lev. obs.",
        "Bloque II: 03 Exp. Téc. y 03 Obras: 10 Entregables → Inició: 17.07.24",
        "4to, 5to y 6to ET: 6 de 10 entregables aprobados. Entregable N°7 en lev. obs.",
        "Oct.26: Previsto culminar 1er ET. Dic.26: Previsto culminar el 2do y 3er ET. 1er TRIM 2027: Previsto culminar 4to, 5to y 6to ET.",
        "Supervisión de obra, en proceso de selección (en negociación). La adjudicación depende de la culminación del 1er ET.",
        "ETAPA 2: El Triunfo – 01 Exp. Téc. en elaboración: 10 Entregables.",
        "6 de 10 entregables aprobados. Entregable N°7 en elaboración.",
        "ETAPA 3: La Joya – 02 Exp. Téc. en elaboración: 12 entregables",
        "7 de 10 entregables aprobados (Norte Alameda y Joya Sur). Entregable N°8 en elaboración."
      ],
      alert: null,
      hitos: [
        { fecha: "Nov.26", titulo: "Etapa 1 — Inicio de obra del 1er ET-Bloque I." },
        { fecha: "Set.26", titulo: "Etapa 2 — Presentación del entregable N°7." },
        { fecha: "Set.26", titulo: "Etapa 3 — Presentación del entregable N°8 (Norte Alameda)." },
        { fecha: "Oct.26", titulo: "Etapa 3 — Entregable N°8 – Joya Sur." }
      ],
      riesgo: [
        "ETAPA 1: Retrasos en la elaboración de ET (responsabilidad del contratista, el cual tiene deudas pendientes con subcontratista), ponen en riesgo programación de ejecución.",
        "GENERAL: En julio 2026 se presentó la solicitud de ampliación de plazo de desembolsos del contrato de préstamo por 45 meses (hasta diciembre de 2030)."
      ],
      deadline: "04.03.27",
      chart: {
        max: 23,
        ejecucion: [0, 0.1, 0.5, 1.1, 0.3, 0, 0.3, 0.1, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.4, 0.5, 1.6, 17.7, 2.2],
        metaMEF: [null, null, null, null, null, null, null, 0.3, 0.3, 10, 18.7, 21.7]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2309846",
      fin: {
        costo: "S/ 153.3 MM", devengado: "S/ 108.0 MM", avance: "70.4%",
        pim: "S/ 53.0 MM", certificado: "S/ 53.0 MM", devengado26: "S/ 30.4 MM",
        pimEjecutar: "S/ 22.6 MM", ffRO: "S/ 22.6 MM", ffROOC: "—"
      },
      fechaInicio: "20/02/25", fechaFin: "20/11/26", avProg: "60.20%", avEjec: "54.50%",
      notes: [
        "Avance físico → Programado: 60.20% - Ejecutado: 54.50% (Jul 2026)",
        "Se viene ejecutando las redes de agua potable, redes secundarias de alcantarillado, conexiones domiciliarias y reposición de pavimentos.",
        "La obra presenta retrasos por modificaciones contractuales, ejecución de otras obras en las zonas de intervención, demora en la obtención de permisos y licencias del MTC, formalización de conexiones clandestinas, alta de empalme a reservorios de la obra PTAP Sullana paralizada y oposición de pobladores a las intervenciones del proyecto.",
        "Ago.26: Se programó S/ 8.0 MM para el pago de la Valorización de Obra N°18 (Jul 26), Mayores Metrados N° 02, 04, 05 y 06 de Redes y Conexiones Domiciliarias, Prestaciones Adicionales, y Valorización de Supervisión N° 17, principalmente."
      ],
      alert: null,
      hitos: [
        { fecha: "20/11/26", titulo: "Culminación de la obra. Ampliaciones de plazo en revisión de la JRD." }
      ],
      riesgo: [
        "Demoras en obtención de permisos y licencias; y problemas con los pobladores por intervenciones del proyecto.",
        "Retraso en la formalización de conexiones clandestinas por la EPS Grau."
      ],
      deadline: "08.09.26",
      chart: {
        max: 10,
        ejecucion: [3.8, 3.5, 2.4, 1.6, 5, 3.1, 3.9, 7.3, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 8, 4.5, 8.4, 6.6, 2.4],
        metaMEF: [null, null, null, null, null, null, null, 4.4, 4.5, 8.4, 6.6, 6.8]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2561234",
      fin: {
        costo: "S/ 477.5 MM", devengado: "S/ 39.7 MM", avance: "8.3%",
        pim: "S/ 51.6 MM", certificado: "S/ 7.7 MM", devengado26: "S/ 5.0 MM",
        pimEjecutar: "S/ 46.5 MM", ffRO: "S/ 2.0 MM", ffROOC: "S/ 44.5 MM"
      },
      fechaInicio: "—", fechaFin: "—", avProg: "—", avEjec: "—",
      notes: [
        "ETAPA 1: Obra culminada, en proceso de transferencia.",
        "ETAPA 2: ET aprobado, mediante RD N° 034-2026-VIVIENDA/VMCS/PNSU/DE",
        "El BID validó el planteamiento técnico ajustado, que incluye la reducción de metas de la Etapa 2, luego de la información complementaria remitida entre fines de junio e inicios de julio. Se vienen elaborando los documentos de licitación (DDL) para convocar la obra.",
        "ETAPA 3: ET en actos previos",
        "El BID validó el planteamiento técnico que permite ejecutar en paralelo la Sección 3.1 de la Etapa 3 con la Etapa 2, reduciendo la demanda presupuestal de corto plazo. Actualmente, el BID viene evaluando los documentos de licitación (DDL). La demanda adicional para financiar las demás secciones de la Etapa 3 (3.2, 3.3, 3.4 y 3.5) fue sustentada ante el MEF a inicios de julio de 2026.",
        "Se requiere disponibilidad presupuestal adicional de S/ 320 MM de contrapartida nacional, a lo previsto en el contrato de préstamo para ejecutar toda la Etapa."
      ],
      alert: null,
      hitos: [
        { fecha: "Set.26", titulo: "Etapa 2 — Convocatoria de Obra (condicionada a la No Objeción del BID al DDL)." },
        { fecha: "Set.26", titulo: "Etapa 3 — Convocatoria de Diseño-Construcción de sección 3.1 (condicionada a la No Objeción del BID al DDL enviado)." },
        { fecha: "Set.26", titulo: "Etapa 3 — Nueva reunión tripartita (BID, MVCS y MEF) para definir priorización de inversiones, según el resultado de la Demanda adicional presentada al MEF." }
      ],
      riesgo: [
        "—"
      ],
      ...
      chart: {
        max: 3,
        ejecucion: [0.3, 0.9, 0.7, 0.8, 0.5, 0.5, 1.1, 0.2, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.8, 0.6, 0.5, 0.8, 0.8],
        metaMEF: [null, null, null, null, null, null, null, 0.9, 0.8, 0.8, 2.1, 2.7]
      }
    },

    {
      id: "piura", tab: "Piura Castilla", title: "Piura Castilla",
      status: "En Ejecución", statusType: "agua potable, alcantarillado y PTAR", cui: "2302373",
      fin: {
        costo: "S/ 706.4 MM", devengado: "S/ 15.5 MM", avance: "2.2%",
        pim: "S/ 20.4 MM", certificado: "S/ 20.2 MM", devengado26: "S/ 0.2 MM",
        pimEjecutar: "S/ 20.2 MM", ffRO: "S/ 20.2 MM", ffROOC: "—"
      },
      fechaInicio: "23/09/25", fechaFin: "31/10/28", avProg: "—", avEjec: "—",
      notes: [
        "Fin operación asistida: 31.10.2029. Ejecución obra: Diseño y Construcción con Est. Básico de ingeniería. El Expediente Técnico se elabora por secciones.",
        "Sección 01: Inició 23.09.25 → 2 de 3 Inf. aprobados. Inf. 3 en levantamiento de observaciones.",
        "Sección 02: Inició 23.10.25 → 1 de 3 Inf. aprobados. Inf. 2 en elaboración. Inf. 3 no iniciado.",
        "Sección 03: Inició 22.11.25 → 1 de 3 Inf. aprobados. Inf. 2 en elaboración. Inf. 3 no iniciado.",
        "Sección 04: Inició 22.12.25 → 1 de 3 Inf. aprobados. Inf. 2 en elaboración. Inf. 3 no iniciado.",
        "Sección 05: Inició 21.01.26 → 1 de 3 Inf. aprobados. Inf. 2 en elaboración. Inf. 3 no iniciado.",
      ...
      riesgo: [
        "Superposición y usurpación de predios en algunos tramos de las servidumbres de acceso hacia la Cámara de Bombeo de Desagüe N° 01",
        "Falta de Saneamiento Físico Legal (con problemas judiciales en 6 AA.HH de la Sección 3).",
        "Demora en la obtención de permisos del ANA y el Proyecto Especial Chira Piura, debido al replanteo del trazado de emisores de descarga (Ejidos y Tacalá).",
        "Aprobación de la actualización del Instrumento de Gestión Ambiental Integral condiciona el inicio de la ejecución de obra en las secciones previstas."
      ],
      deadline: "01.08.28",
      chart: {
        max: 21,
        ejecucion: [0, 0, 0.1, 0, 0, 0, 0, 0, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0, 0, 2.7, 15, 2.5],
        metaMEF: [null, null, null, null, null, null, null, 0, 1.9, 15, 3.9, 19.9]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable", cui: "2331579",
      fin: {
        costo: "S/ 203.0 MM", devengado: "S/ 171.3 MM", avance: "84.4%",
        pim: "S/ 60.0 MM", certificado: "S/ 60.0 MM", devengado26: "S/ 43.4 MM",
        pimEjecutar: "S/ 16.7 MM", ffRO: "S/ 16.7 MM", ffROOC: "—"
      },
      fechaInicio: "27/09/24", fechaFin: "05/12/26", avProg: "70.0%", avEjec: "71.8%",
      notes: [
        "Avance físico → Programado: 70.0% - Ejecutado: 71.8% (Jul 2026)",
        "La obra presenta limitaciones por modificaciones contractuales y restricciones de demanda eléctrica.",
        "Se viene ejecutando el reservorio elevado, estación de bombeo de agua, cámara de bombeo de desagüe, instalación de red de emisor submarino y osmosis inversa y la construcción de PTAR-PTAP.",
        "Ago.26: Se programó S/ 3.4 MM para el pago de la Valorización de Obra N° 23 (Jun 2026), Prestacionales Adicionales y Valorización de Supervisión N° 22 y 23, principalmente."
      ],
      alert: null,
      hitos: [
        { fecha: "26/12/26", titulo: "Culminación de la obra." }
      ],
      riesgo: [
        "Dificultades en la operación por problemas de suministro de energía eléctrica."
      ],
      ...
      chart: {
        max: 14,
        ejecucion: [12.8, 2.8, 2.9, 5, 4.5, 3.6, 9.2, 2.7, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 3.4, 6.2, 3.4, 3.4, 2.9],
        metaMEF: [null, null, null, null, null, null, null, 3.7, 6.2, 3.4, 3.4, 5]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable", cui: "2536439",
      fin: {
        costo: "S/ 367.5 MM", devengado: "S/ 159.6 MM", avance: "43.4%",
        pim: "S/ 53.5 MM", certificado: "S/ 53.5 MM", devengado26: "S/ 35.3 MM",
        pimEjecutar: "S/ 18.2 MM", ffRO: "S/ 18.2 MM", ffROOC: "—"
      },
      fechaInicio: "14/12/24", fechaFin: "27/11/26", avProg: "99.7%", avEjec: "77.0%",
      notes: [
        "ETAPA 1: Obra en ejecución. Avance físico → Programado: 99.7% - Ejecutado: 77.0% (Jul 2026)",
        "13.02.26: D.U. 001-2026, autoriza el financiamiento de las IRI.",
        "La inversión comprende: redes colectoras y secundarias de alcantarillado, redes de distribución de agua, conexiones domiciliarias y líneas de impulsión de aguas residuales.",
        "Presentó retrasos en la elaboración de expedientes de adicionales de obra.",
        "Ago.2026: se programó S/ 13.1 MM, correspondiente al pago de la Valorización de obra N° 20 (Jul 2026), Mayores Metrados de Perforación Horizontal, Prestaciones Adicionales y Valorización de Supervisión de Obra N° 01 Prestación Adicional 01, principalmente.",
        "ETAPA 2: ET en elaboración por EPS.",
        "ETAPA 3: Obra en actuaciones preparatorias. Con publicación de expresión de interés. Requiere recursos presupuestales."
      ],
      alert: { text: "Déficit presupuestal de S/ 26.4 MM para el pago total de valorizaciones Etapa I y S/ 48.6 MM para la convocatoria Etapa III, contemplado en el segundo pedido de demanda adicional 2026." },
      hitos: [
        { fecha: "27/11/26", titulo: "Etapa 1 — Culminación de la obra." }
      ],
      riesgo: [
        "ETAPA 1: Posible afectación de la obra por lluvias asociadas al Fenómeno El Niño, por lo que se viene concluyendo las partidas de redes y conexiones."
      ],
      deadline: "24.09.26",
      chart: {
        max: 13,
        ejecucion: [0, 6.6, 2.4, 11.5, 3.2, 5.5, 4.3, 1.7, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 11.5, 4.7, 3.8, 0, 0],
        metaMEF: [null, null, null, null, null, null, null, 5.7, 4.7, 5.7, 3.3, 0]
      }
    },

    {
      id: "dp zarumilla", tab: "DP Zarumilla", title: "DP Zarumilla",
      status: "Por Etapas", statusType: "drenaje pluvial", cui: "2567526",
      fin: {
        costo: "S/ 265.7 MM", devengado: "S/ 17.4 MM", avance: "6.5%",
        pim: "S/ 62.5 MM", certificado: "S/ 17.9 MM", devengado26: "S/ 3.7 MM",
        pimEjecutar: "S/ 58.8 MM", ffRO: "—", ffROOC: "S/ 58.8 MM"
      },
      fechaInicio: "—", fechaFin: "—", avProg: "—", avEjec: "—",
      notes: [
        "ETAPA 1: Obra en proceso de selección",
        "14.08.26: Se suscribió el contrato de obra.",
        "17.08.26: Se adjudicó la supervisión de obra.",
        "ETAPA 2: Exp. Técnico en elaboración – 07 entregables",
        "Inició el 25/06/2025, con un avance de 80%.",
        "Entregables del 1 al 5 aprobado.",
        "Entregable N° 06 en levantamiento de observaciones (4ta versión).",
        "ETAPA 3: Exp. Téc. en actos previos (previsto ejecución: Diseño y Construcción)",
        "Diciembre 2025, se culminó la actualización del presupuesto del ET (supera los S/ 180 MM).",
        "Por convocar, presenta limitada disponibilidad presupuestal para la ejecución bajo el esquema de Diseño y Construcción."
      ],
      alert: null,
      hitos: [
        { fecha: "11/09/26", titulo: "ETAPA 1 — Suscripción de contrato de supervisión de obra." },
        { fecha: "30/09/26", titulo: "ETAPA 2 — Culminación del Expediente Técnico." },
        { fecha: "Set.26", titulo: "ETAPA 3 — Nueva reunión tripartita (BID, MVCS y MEF) para definir priorización de inversiones (metas que podrán ser ejecutadas), según el resultado de la Demanda adicional presentada a MEF en Julio 2026." }
      ],
      riesgo: [
        "ETAPA 3: Falta de disponibilidad presupuestal para iniciar la convocatoria de obra."
      ],
      ...
      chart: {
        max: 20,
        ejecucion: [0, 1.8, 0.1, 0.1, 0.8, 0.1, 0.7, 0, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 1.6, 18.1, 0.2, 1.3, 1.6],
        metaMEF: [null, null, null, null, null, null, null, 1.6, 0.1, 1.3, 6.7, 11.1]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "alcantarillado", cui: "2678483",
      fin: {
        costo: "S/ 73.3 MM", devengado: "S/ 43.7 MM", avance: "59.7%",
        pim: "S/ 43.1 MM", certificado: "S/ 43.1 MM", devengado26: "S/ 31.1 MM",
        pimEjecutar: "S/ 12.0 MM", ffRO: "S/ 12.0 MM", ffROOC: "—"
      },
      fechaInicio: "02/09/25", fechaFin: "18/12/26", avProg: "100.00%", avEjec: "69.51%",
      notes: [
        "Emisor Norte → Inicio: 02.09.25 - Fin: 18.12.26 (Estimado). Programado: 100.00% - Ejecutado: 69.51% (Jul 2026)",
        "Emisor Sur → Inicio: 28.10.25 - Fin: 12.09.26. Programado: 93.50% - Ejecutado: 54.85% (Jul 2026)",
        "Presenta interferencia no prevista por tubería de agua de 500 mm al mismo nivel del Emisor Norte, se encuentra en trámite la aprobación de un Adicional de Obra. Asimismo, se tiene restringido 1,500 m de tubería hasta el funcionamiento de los nuevos emisores a solicitud de EPSEL.",
        "Ago.2026: Se devengó S/ 1.6 MM correspondiente al pago de la Valorización de Obra N° 11 Emisor Norte, Valorización de Obra N° 10 Emisor Sur y Valorización de Supervisión N° 12, principalmente."
      ],
      alert: { text: "Déficit presupuestal de S/ 17.5 MM para cubrir el pago total de valorizaciones, contemplado en el segundo pedido de demanda adicional 2026." },
      hitos: [
        { fecha: "27/08/26", titulo: "Aprobación de la ampliación de plazo - obra Emisor Norte, hasta 18.12.26." },
        { fecha: "12/09/26", titulo: "Culminación de la obra – Emisor Sur. En gestión la ampliación de plazo hasta Dic. 26." }
      ],
      riesgo: [
        "Aplazamiento del término de obra por interferencias y restricciones."
      ],
      ...
      chart: {
        max: 8,
        ejecucion: [5.1, 4.8, 6, 3.1, 5, 2.6, 3.1, 1.6, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 5.2, 6.2, 2.1, 0, 0],
        metaMEF: [null, null, null, null, null, null, null, 4.2, 6.2, 2.4, 0, 0]
      }
    },
...

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2395187",
      fin: {
        costo: "S/ 898.4 MM", devengado: "S/ 340.6 MM", avance: "37.9%",
        pim: "S/ 160.2 MM", certificado: "S/ 160.2 MM", devengado26: "S/ 145.9 MM",
        pimEjecutar: "S/ 14.3 MM", ffRO: "S/ 14.3 MM", ffROOC: "—"
      },
      fechaInicio: "05/08/25", fechaFin: "05/09/28", avProg: "16.16%", avEjec: "14.45%",
      notes: [
        "Ejecución atrasada. Avance físico programado acumulado mayor al ejecutado.",
        "En ejecución: Líneas y redes de Alcantarillado en los Sectores 358, 357 y 359; Redes de agua potable en los Sectores 359 y 360; Excavación para el Reservorio de Rebombeo Proyectado 02.",
        "Respecto al pago de adelantos:",
        "Adelanto Directo (10%) por S/ 80.6 MM, se realizó el pago total.",
        "Adelanto de Materiales (20%) por S/ 161.2 MM, se realizó el pago de S/ 128.4 MM, quedando pendiente el pago de S/ 32.8 MM.",
        "El proyecto no cuenta con presupuesto para el pago de valorizaciones de agosto a diciembre. El 06.05.26 se solicitó demanda adicional al MEF y no fue atendida. El 19.08.26 se remitió demanda adicional actualizada por S/ 135.4 MM (MEF – HR: E-135344-2026).",
        "El déficit actualizado asciende a S/ 135 MM, de los cuales se requiere para el pago de valorizaciones, mayores metrados, mayores gastos generales y adelanto de materiales."
      ],
      alert: null,
      hitos: [
        { fecha: "Julio", titulo: "Pago de la Valorización de Obra N° 12 por S/ 12.84 Millones (Sin financiamiento)." }
      ],
      riesgo: [
        "ALTO: Incumplimiento del contrato por falta de presupuesto para el pago del adelanto de materiales y de las valorizaciones de julio a diciembre.",
        "ALTO: Falta de Libre disponibilidad del RAP-07 (Depende de SEDAPAL)."
      ],
      deadline: "19.07.28",
      chart: {
        max: 33,
        ejecucion: [27.6, 12.1, 12.6, 31.2, 28.6, 20.8, 12.8, 0.2, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 1.8, 3, 4.1, 3, 2.5],
        metaMEF: [null, null, null, null, null, null, null, 11.7, 0.6, 3.3, 0, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2309659",
      fin: {
        costo: "S/ 821.7 MM", devengado: "S/ 371.3 MM", avance: "45.2%",
        pim: "S/ 100.7 MM", certificado: "S/ 98.9 MM", devengado26: "S/ 97.5 MM",
        pimEjecutar: "S/ 3.2 MM", ffRO: "S/ 3.2 MM", ffROOC: "—"
      },
      fechaInicio: "16/10/24", fechaFin: "31/08/28", avProg: "38.56%", avEjec: "45.21%",
      notes: [
        "Desempeño adelantado: Avance físico programado acumulado menor al ejecutado.",
        "La ejecución física continúa en sus 8 frentes, con la inclusión de avance en los reservorios mejorados (rehabilitados / reconstruidos) R-1-273, R-1-277, RP-03-395, RP-04-279, RP-07-395, RP-08-395, R-5-394, R-3-278 y R-2-273 así como la continuación en los reservorios RAP-04-278, RP-06-395, RRP-01-279, RAP-06-277 y RP-05B; así como en muros de contención y cámaras en toda la obra.",
        "El proyecto no cuenta con presupuesto para el pago de valorizaciones de agosto a diciembre. El 06.05.26 se solicitó demanda adicional al MEF y no fue atendida. El 19.08.26 se remitió demanda adicional actualizada por S/ 89.4 MM para completar el pago de los mayores gastos generales, mayores metrados, valorizaciones mensuales de ejecución de obra y adicionales de obra."
      ],
      alert: null,
      hitos: [
        { fecha: "Agosto", titulo: "Pago de Valorización de Obra N° 22 de julio por S/ 12.76 MM; se vienen realizando gestiones para su financiamiento." }
      ],
      riesgo: [
        "Incumplimiento del contrato por falta de presupuesto para el pago de las valorizaciones de agosto a diciembre."
      ],
      deadline: "04.04.28",
      chart: {
        max: 19,
        ejecucion: [14.6, 11.5, 15.1, 12.1, 13.2, 17.5, 1, 12.5, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 12.5, 1.7, 0.5, 0.5, 0.5],
        metaMEF: [null, null, null, null, null, null, null, 0, 0, 0, 0, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2403503",
      fin: {
        costo: "S/ 511.4 MM", devengado: "S/ 195.4 MM", avance: "38.2%",
        pim: "S/ 61.1 MM", certificado: "S/ 59.8 MM", devengado26: "S/ 43.9 MM",
        pimEjecutar: "S/ 17.2 MM", ffRO: "S/ 17.2 MM", ffROOC: "—"
      },
      fechaInicio: "23/08/24", fechaFin: "23/09/27", avProg: "87.68%", avEjec: "53.86%",
      notes: [
        "Desempeño atrasado: Avance físico programado acumulado mayor que el ejecutado.",
        "En ejecución en 05 frentes de trabajo, incluyendo concreto de cámaras, cisternas y reservorios (PAO N° 7), además en redes de agua potable, de alcantarillado, conexiones domiciliarias, y reposición de pavimentos (PAO N°1).",
        "El 12.06.2026 PASLC otorgó opinión favorable a la reformulación de los cronogramas del Supervisor Consorcio Supervisión Sur, derivada de la Decisión N.° 13 de la JRD, manteniéndose la fecha de culminación reprogramada para el 23.09.2027.",
        "Mediante Decisión de la Medida Provisional N°01 de fecha 02.07.2026, la JRD ordenó la abstención del requerimiento del cronograma acelerado hasta el dictamen de la Controversia N°20."
      ],
      alert: null,
      hitos: [
        { fecha: "Agosto", titulo: "Pago de Valorización de Obra N° 24 por S/ 1.55 MM, Supervisión de obra N°19 por S/ 0.5 MM y de Adicionales por S/ 0.5 MM. Asimismo, se encuentra en curso mayores metrados de obra por S/ 3.04 MM." }
      ],
      riesgo: [
        "MEDIO: Incumplimiento del contrato por falta de presupuesto para el pago de las valorizaciones contractuales, adicionales y valorizaciones por MMO por replanteos."
      ],
      deadline: "01.08.27",
      chart: {
        max: 12,
        ejecucion: [3.7, 10.2, 4.9, 8.5, 4.6, 3.3, 6.7, 2, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 2, 4.7, 2.7, 5, 4.8],
        metaMEF: [null, null, null, null, null, null, null, 4.5, 5.1, 7.2, 6, 5.4]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2300050",
      fin: {
        costo: "S/ 311.5 MM", devengado: "S/ 84.5 MM", avance: "27.1%",
        pim: "S/ 50.0 MM", certificado: "S/ 49.9 MM", devengado26: "S/ 49.1 MM",
        pimEjecutar: "S/ 0.8 MM", ffRO: "S/ 0.8 MM", ffROOC: "—"
      },
      fechaInicio: "03/12/25", fechaFin: "25/07/27", avProg: "9.88%", avEjec: "9.17%",
      notes: [
        "Desempeño Atrasado: Avance físico programado acumulado mayor que el ejecutado.",
        "Movimiento de tierras y ejecución de redes: culminación con la excavación en terreno normal correspondiente a la estructura CP-01. En el Sector 334, respecto de las líneas de conducción, se ejecutaron 189.44 ml, mientras que en las troncales estratégicas se alcanzó un avance de 1,614.72 ml.",
        "Redes secundarias y conexiones de agua potable y alcantarillado: en el Sector 335 se ejecutaron 150.09 ml de redes de agua potable; en el Sector 336, 698.70 ml; y en el Sector 343, 3,795.17 ml. En el Sector 337 se instalaron 46 buzones, mientras que en el Sector 343 se instalaron 130 buzones y 98 buzonetas.",
        "Se debe adelanto de materiales por S/ 25 MM.",
        "El proyecto no cuenta con presupuesto para el pago de valorizaciones a diciembre. El 06.05.26 se solicitó demanda adicional al MEF y no fue atendida. El 19.08.26 se remitió demanda adicional actualizada por S/ 90.4 MM para el adelanto de materiales, valorizaciones mensuales de ejecución de obra y adicionales de obra.",
        "El déficit actualizado asciende a S/ 90.35 MM."
      ],
      alert: null,
      hitos: [
      ...
      riesgo: [
        "Incumplimiento del contrato por falta de presupuesto para el pago del adelanto de materiales y de las valorizaciones de julio a diciembre."
      ],
      deadline: "25.07.27",
      chart: {
        max: 17,
        ejecucion: [1.2, 8, 11.6, 15.9, 2.5, 4.2, 5.7, 0.1, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.1, 0.2, 0.2, 0.2, 0.2],
        metaMEF: [null, null, null, null, null, null, null, 0, 0, 0, 0, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2389079",
      fin: {
        costo: "S/ 1,816.8 MM", devengado: "S/ 27.7 MM", avance: "1.5%",
        pim: "S/ 2.6 MM", certificado: "S/ 2.4 MM", devengado26: "S/ 0.9 MM",
        pimEjecutar: "S/ 1.7 MM", ffRO: "S/ 1.7 MM", ffROOC: "—"
      },
      fechaInicio: "21/10/26", fechaFin: "11/08/28", avProg: "0.00%", avEjec: "0.00%",
      notes: [
        "Proyecto incluido en la lista de inversiones complementarias priorizadas en el Plan Nacional de Infraestructura Sostenible para la Competitividad 2022-2025 (PNISC). Decreto Supremo N° 048-2024-EF.",
        "Etapa I: ET aprobado sin financiamiento para convocar proceso de selección. Se presentó Demanda Adicional para el ejercicio 2026 (36.1 MM) y para el ejercicio 2027 (S/ 76.9 MM).",
        "Demanda adicional en la programación 2027-2029. Su déficit corresponde a la previsión 2027, para las convocatorias de obra y supervisión de obra de la ETAPA 1 (180 MM).",
        "Etapa II: Obra y Supervisión (En proceso de selección).",
        "Obra: Se otorgó la Buena Pro el 31.07.2026, por el monto de S/ 83,041,302.93; la Buena Pro es materia de apelación ante la Secretaría Técnica del Tribunal OECE.",
        "Supervisión: Convocado el 03.06.2026, actualmente en la etapa de absolución de consultas y observaciones.",
        "A la espera de la respuesta del MEF para la reversión de los recursos dispuesto en el marco del DS 155-2026-EF; el proceso tenía buena pro antes del 31/07/2026.",
        "Etapa III: El contrato de consultoría para la elaboración del expediente técnico y de la supervisión se encuentra suspendido desde el 21.01.2026, hasta la aprobación de la ubicación definitiva del Reservorio RP-01 (en evaluación por SEDAPAL).",
        "Mediante HR N° 183406-2026 de fecha 25.08.2026 el MVCS ha solicitado al MEF la asignación de recursos adicionales por el monto de S/ 21,038,257.00, la cual se encuentra en evaluación."
      ],
      alert: null,
      hitos: [
        { fecha: "30/09/26", titulo: "Etapa II — Plazo para que la Secretaría Técnica del Tribunal OECE resuelva el recurso de apelación interpuesto al otorgamiento de la Buena Pro. Hasta esa fecha se requieren los recursos, de lo contrario se deberá cancelar." }
      ],
      riesgo: [
        "BAJO: Etapa I – Pérdida de vigencia del ET por falta de financiamiento para la ejecución de la obra.",
        "ALTO: Etapa II - Cancelación del proceso, por falta de financiamiento del adelanto directo de obra en 2026."
      ],
      deadline: "—",
      chart: {
        max: 30,
        ejecucion: [0, 0, 0.8, 0, 0, 0, 0, 0, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0, 0.5, 0.5, 0.5, 0.2],
        metaMEF: [null, null, null, null, null, null, null, 0.2, 1.1, 27.4, 4.3, 3.5]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2396141",
      fin: {
        costo: "S/ 318.6 MM", devengado: "S/ 46.8 MM", avance: "14.7%",
        pim: "S/ 24.3 MM", certificado: "S/ 24.2 MM", devengado26: "S/ 9.1 MM",
        pimEjecutar: "S/ 15.3 MM", ffRO: "S/ 15.3 MM", ffROOC: "—"
      },
      fechaInicio: "10/04/2024", fechaFin: "27/06/2028", avProg: "65% (ET)", avEjec: "45% (ET)",
      notes: [
        "Expediente Técnico - Avance físico → Programado: 65% - Ejecutado: 45%",
        "Ejecución de Obra (Sección 01) - Avance físico → Programado: 0.03% - Ejecutado: 0.11%",
        "El proyecto contempla la elaboración del expediente técnico en 03 Secciones y su posterior ejecución de obra, bajo la modalidad de concurso oferta (diseño y construcción).",
        "Sección 01: En fecha 02.06.2026 se comunicó la aprobación del expediente técnico.",
        "Sección 02: A la fecha, el Informe de Estudios Definitivos se encuentra en calidad de OBSERVADO, estando pendiente la subsanación por el Consultor.",
        "Sección 03: Se encuentra pendiente la presentación del Informe de Estudios Definitivos por parte del Consultor.",
        "De la ejecución de obra: 09.07.2026: Inicio ejecución de Obra – Sección N° 1. 10.08.2026: Presentación de la Valorización de Obra N° 1 – Sección N° 1.",
        "El 19.08.26 se remitió demanda adicional actualizada (MEF – HR: E-135344-2026). El déficit actualizado asciende a S/ 9 MM."
      ],
      alert: null,
      hitos: [
        { fecha: "31/08/26", titulo: "Presentación levantamiento de observaciones de estudios definitivos Sección N° 2." }
      ],
      riesgo: [
        "ALTO: Incumplimiento del contrato por falta de presupuesto para el pago del adelanto de materiales y de las valorizaciones de setiembre a diciembre."
      ],
      ...
      chart: {
        max: 24,
        ejecucion: [0, 0, 0, 0, 0, 0, 9, 0, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 1.3, 1.3, 1.7, 2.8, 8.3],
        metaMEF: [null, null, null, null, null, null, null, 22.4, 1.1, 0.8, 0, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2339705",
      fin: {
        costo: "S/ 336.7 MM", devengado: "S/ 37.8 MM", avance: "11.2%",
        pim: "S/ 5.8 MM", certificado: "S/ 5.5 MM", devengado26: "S/ 1.3 MM",
        pimEjecutar: "S/ 4.5 MM", ffRO: "S/ 4.5 MM", ffROOC: "—"
      },
      fechaInicio: "16/04/2024", fechaFin: "31/12/2026", avProg: "46%", avEjec: "30%",
      notes: [
        "Ejecución atrasada: Avance físico programado acumulado mayor que el ejecutado.",
        ...
        "Sección 03: 15.06.2026: El Consorcio Supervisor, se dirigió al Consultor, a efectos de comunicar que el Informe de Estudios Definitivos se encuentra APROBADO.",
        "Sección 04: Iniciará una vez culminados los entregables de las Secciones N° 1, 2 y 3, conforme a los Términos de Referencia.",
        "No se cuenta con asignación presupuestal para convocatoria del procedimiento de selección para la elaboración del EXPEDIENTE TÉCNICO de la PTAR PROFAM (2027)."
      ],
      alert: null,
      hitos: [
        { fecha: "31/08/26", titulo: "Presentación Expediente Técnico Sección 2." },
        { fecha: "15/09/26", titulo: "Aprobación de Expediente Técnico Sección 1 por Supervisor." }
      ],
      riesgo: [
        "ALTO: Puesta en marcha del servicio de redes por falta de PTAR para la descarga de alcantarillado."
      ],
      deadline: "—",
      chart: {
        max: 10,
        ejecucion: [0, 0, 0, 0.3, 0.5, 0, 0.4, 0, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.9, 0.5, 2.5, 0.6, 0],
        metaMEF: [null, null, null, null, null, null, null, 0.7, 0.5, 9.2, 0.6, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2344329",
      fin: {
        costo: "S/ 144.4 MM", devengado: "S/ 119.1 MM", avance: "82.5%",
        pim: "S/ 12.3 MM", certificado: "S/ 12.3 MM", devengado26: "S/ 6.8 MM",
        pimEjecutar: "S/ 5.5 MM", ffRO: "S/ 5.5 MM", ffROOC: "—"
      },
      fechaInicio: "08/04/26", fechaFin: "03/12/26", avProg: "7.99%", avEjec: "6.52%",
      notes: [
        "ET (Secciones 1-4): Inicio 29.02.2024 - Fin 19.05.2025. Avance físico → Programado: 100% - Ejecutado: 66%. Ejecución ET Saldo de Obra atrasada.",
        "Entregables N.° 1, N.° 2 y N.° 3: se encuentran APROBADOS. Entregable N°4: en proceso de levantamiento de observaciones a la Versión 3. Entregables N°5 y N°6: pendientes de presentación.",
        "OBRA (Sección 05): Inicio 08.04.2026 - Fin 03.12.2026. Avance físico → Programado: 7.99% - Ejecutado: 6.52%. Ejecución de Obra atrasada: avance programado mayor al ejecutado.",
        "En el componente de Obras Civiles, la diferencia respecto al avance programado obedece al tiempo requerido para la atención de las consultas formuladas al proyectista y a la necesidad de precisiones técnicas, por lo que se proyecta realizar consulta a Pluz Energía.",
        "El 06.05.26 se solicitó demanda adicional y se reiteró el 15.07.26 (MEF – HR: E-100510-2026). El 19.08.26 se remitió demanda adicional actualizada (MEF – HR: E-135344-2026). El déficit actualizado asciende a S/ 16.7 MM."
      ],
      alert: null,
      hitos: [
      ...
      chart: {
        max: 5,
        ejecucion: [0, 0, 0.2, 4.3, 0.3, 0.5, 1.3, 0.2, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.6, 1.6, 0.9, 1.3, 1.3],
        metaMEF: [null, null, null, null, null, null, null, 1.9, 1.8, 1.5, 0.4, 0]
      }
    },

    {
      ...
      status: "En Ejecución", statusType: "agua potable y alcantarillado", cui: "2317154",
      fin: {
        costo: "S/ 96.2 MM", devengado: "S/ 85.6 MM", avance: "88.9%",
        pim: "S/ 8.1 MM", certificado: "S/ 8.1 MM", devengado26: "S/ 5.8 MM",
        pimEjecutar: "S/ 2.3 MM", ffRO: "S/ 2.3 MM", ffROOC: "—"
      },
      fechaInicio: "29/02/24", fechaFin: "15/11/26", avProg: "99.83%", avEjec: "95.87%",
      notes: [
        "Fecha Fin: 15.11.2026 (04/12/2026 por ampliaciones).",
        "Ejecución atrasada: Avance físico programado acumulado mayor que el ejecutado.",
        "Se viene dando el proceso de transferencia parcial de 481 conexiones domiciliarias de agua y alcantarillado, cámaras reductoras de presión, cámaras de válvula de aire y cámaras de purga.",
        "Se viene gestionando dos Adicionales de obra: “Filtros pasivos de armónicos y supresores de sobretensiones transitorias en las estaciones CB-02-01, CB-03 y CB-04” y la “Energización de la Cámara de bombeo CB-02”.",
        "El 19.08.26 se remitió demanda adicional actualizada (MEF – HR: E-135344-2026). El déficit actualizado asciende a S/ 8.5 MM en Mayores Metrados."
      ],
      alert: null,
      hitos: [
        { fecha: "Agosto", titulo: "Pago de las valorizaciones de supervisión de obra correspondientes al periodo julio." }
      ],
      riesgo: [
        "—"
      ],
      ...
      chart: {
        max: 3,
        ejecucion: [0, 0.6, 0.7, 0.9, 1.5, 0.7, 1, 0.4, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 0.8, 1.9, 0, 0, 0],
        metaMEF: [null, null, null, null, null, null, null, 1.1, 1.1, 0, 0, 0]
      }
    },
...

    {
      ...
      status: "En Ejecución", statusType: "agua potable y saneamiento", cui: "2461584",
      fin: {
        costo: "S/ 69.8 MM", devengado: "S/ 52.5 MM", avance: "75.3%",
        pim: "S/ 15.6 MM", certificado: "S/ 13.0 MM", devengado26: "S/ 6.9 MM",
        pimEjecutar: "S/ 8.6 MM", ffRO: "S/ 8.6 MM", ffROOC: "—"
      },
      fechaInicio: "09/11/23", fechaFin: "14/10/26", avProg: "65.58%", avEjec: "57.49%",
      notes: [
        "Ejecutada por el Consorcio CARATA (Modalidad de contrata).",
        "Adicionales de Obra 01 al 09 aprobados y los deductivos Vinculantes 01 al 05.",
        "Ampliaciones de Plazo 01, 04, 05, 06 y 07 aprobadas (29 d.c – JRD, 120 d.c - JRD, 3 d.c - Entidad, 300 d.c. - JRD, 61 d.c - JRD) por 513 d.c.",
        "La obra estuvo suspendida del 16.01 al 05.04.2026 por factores climatológicos adversos (lluvias). El 06.04.2026, reinició ejecución de obra.",
        "En ejecución de UBS (Unidad Básica de Saneamiento) en las localidades de Coatasi y Lluco (margen derecho), Putucuni y EBAR (Estación de Bombeo de Aguas Residuales).",
        "En agosto, se devengó S/ 1.4 MM correspondiente a obra y supervisión; la menor ejecución se debió a consultas técnicas que condicionaron la continuidad de algunos frentes de trabajo, y limitada disponibilidad de mano de obra especializada por el inicio de la temporada de heladas.",
        "Para setiembre, se prevé una recuperación progresiva de la ejecución, proyectándose ejecutar S/ 1.6 MM, como resultado de la absolución de consultas, apertura de nuevos frentes de trabajo e incorporación de personal especializado.",
        "Los adicionales de obra que aún están por tramitarse, podrían generar solicitudes de ampliación de plazo, pudiendo extender la fecha de culminación hasta en 150 d.c."
      ],
      alert: null,
      hitos: [
        { fecha: "Acciones", titulo: "Seguimiento a la absolución de consultas técnicas y apertura de nuevos frentes de trabajo." }
      ],
      riesgo: [
        "Déficit de presupuesto para los posibles adicionales de obra."
      ],
      deadline: "14.10.26",
      chart: {
        max: 4,
        ejecucion: [0.3, 0.8, 0.1, 0, 1.9, 1.1, 1.5, 1.4, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 1.2, 1.6, 2.5, 2.3, 2.4],
        metaMEF: [null, null, null, null, null, null, null, 3, 3, 1.8, 2.1, 0]
      }
    },
...

    {
      ...
      status: "En Ejecución", statusType: "servicios operativos o misionales institucionales", cui: "2459010",
      fin: {
        costo: "S/ 293.6 MM", devengado: "S/ 205.5 MM", avance: "70.0%",
        pim: "S/ 90.7 MM", certificado: "S/ 90.6 MM", devengado26: "S/ 60.9 MM",
        pimEjecutar: "S/ 29.9 MM", ffRO: "S/ 5.8 MM", ffROOC: "S/ 24.1 MM"
      },
      fechaInicio: "01/05/21", fechaFin: "31/07/27", avProg: "—", avEjec: "—",
      notes: [
        "El BIRF ha aprobado la ampliación de plazo del último desembolso del Acuerdo de Préstamo N° 9035-PE hasta el 31.01.2027.",
        "Levantamiento catastral, Verificación y Validación de la calidad:",
        "Componente 1",
        "Lote 1 culminó levantamiento con un total de 416,551 UUCC validadas. Los Lotes 2, 3A-3B, 3C, 4, 5 y 6, se encuentran en ejecución contractual. En el Lote 3A-3B se han validado 69,310 UUCC, en el Lote 3C se tiene validadas 11,640 UUCC, en el Lote 4 se han validado 81,634 UUCC, en el Lote 5 se han validado 41,476 UUCC y en el Lote 6, ejecutado en convenio con el ICL de la MML se han validado 51,774 UUCC. En resumen, se tiene un total 672,385 UUCC validadas y un total de 401,498 UUCC en campo y en proceso de revisión de calidad.",
        "Componente 2",
        "Fortalecimiento de capacidades: se viene capacitando y certificando en la Gestión Catastral (717 capacitados y 240 certificados). Se han actualizado los PPRRD y PGR de 19 municipalidades priorizadas (22 planes). Se ha culminado la 3ra etapa del SICUN, continuando el mantenimiento y soporte; módulos de planificación y valorización territorial e interoperabilidad, así como funcionalidades de Gestión de Riesgos y Desastres, en los cuales se realizan pruebas del visor de seguimiento.",
        "Componente 3",
        "Este componente contempla los gastos operativos del proyecto, incluidos los pagos de auditoría externa y de la evaluación final del proyecto."
      ],
      alert: null,
      hitos: [
      ...
      riesgo: [
        "Se requiere recursos adicionales de contrapartida para atender las obligaciones contractuales de los siguientes meses, de los cuales el sector ha priorizado la atención de una demanda en RO por S/ 2 millones cuyo trámite se encuentra para opinión técnica de la OPMI de la PCM."
      ],
      deadline: "31.01.27",
      chart: {
        max: 12,
        ejecucion: [3.5, 4.6, 10.2, 9.1, 8.4, 9.8, 9.7, 5.5, null, null, null, null],
        ejecProy: [null, null, null, null, null, null, null, 8, 8.9, 7.3, 6.4, 4.6],
        metaMEF: [null, null, null, null, null, null, null, 9.8, 8.9, 7.3, 3.1, 7]
      }
    }
...
/* Alias de compatibilidad: el corte más reciente */
window.PROJECTS = window.CORTES[window.CORTES.length - 1].projects;
